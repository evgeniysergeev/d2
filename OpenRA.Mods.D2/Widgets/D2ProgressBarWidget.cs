...
namespace OpenRA.Mods.D2.Widgets
{
	public class D2ProgressBarWidget : Widget
	{
		...
		public override void Draw()
		{
			...
			D2WidgetUtils.DrawRedTriangle(new Point(r.Left + BarMargin * 2, r.Bottom), BarMargin);
			D2WidgetUtils.DrawYellowTriangle(new Point((r.Left + r.Right) / 2, r.Bottom), BarMargin);
			D2WidgetUtils.DrawGreenTriangle(new Point(r.Right - 2 * BarMargin, r.Bottom), BarMargin);
