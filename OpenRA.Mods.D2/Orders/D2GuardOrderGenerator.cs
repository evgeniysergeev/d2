 ...
 */
/* Based on on GuardOrderGenerator. Original Copyright: */
/*
...
{
	public class D2GuardOrderGenerator : D2GenericSelectTarget
	{
		public D2GuardOrderGenerator(IEnumerable<Actor> subjects, string order, string cursor, MouseButton button)
